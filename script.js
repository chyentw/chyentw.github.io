...
const publications = [
    ...
    },
    {
        ...
        venue: 'IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), vol. 45, no. 10, pp. 4954–4967, Oct. 2026.',
    ...
    },
    {
        ...
        title: 'Multi-Annotator Learning for Uncertainty-Aware Carotid IMT Estimation via Mixture Density Networks',
        venue: 'IEEE Biomedical Circuits and Systems Conference (BioCAS), to appear, Oct. 2026.',
        topics: ['medical-image']
    },
    {
    ...
    {
        type: 'conference', year: 2026,
        authors: 'Bing-Xin Chen and <strong>Chia-Heng Yen</strong>',
        title: 'Backdoor Attack on GNN-Based Hardware Trojan Detectors Under Continual Learning',
        venue: 'IEEE Asia Pacific Conference on Circuits and Systems (APCCAS), to appear, Oct. 2026.',
        topics: ['hw-security', 'ai-security']
    },
    {
        type: 'conference', year: 2026,
        authors: 'Yu-Ting Hsu and <strong>Chia-Heng Yen</strong>',
        title: 'Layer-Selective ECC Allocation for BF16 KV Cache Reliability in LLM Inference',
        venue: 'IEEE Asia Pacific Conference on Circuits and Systems (APCCAS), to appear, Oct. 2026.',
...
const TOPIC_LABELS = {
    ...
    'ai-security':     'AI Model Security',
    'medical-image':   'Medical Image Analysis',
    'biomed-data':     'Biomedical Data Analytics',
    'circuit-design':  'Arithmetic Circuit Design',
    'ai-reliability':  'Reliable AI Computing'
};
...
const TOPIC_PARENT = {
    ...
    'ai-security':     'Hardware & AI Security',
    'medical-image':   'Biomedical AI',
    'biomed-data':     'Biomedical AI',
    'circuit-design':  'AI Computing & Hardware Design',
    'ai-reliability':  'AI Computing & Hardware Design'
};
...
function renderResearchPubs() {
    document.querySelectorAll('[data-pub-topic]').forEach(container => {
        ...
        if (topicPubs.length === 0) { container.innerHTML = ''; return; }
...
// ============================================================
// RENDER: Teaching / Courses page  (data-driven, like Publications)
// ============================================================
// ============================================================
// Courses Data  (edit here to update the Teaching page)
// ============================================================
// A semester group is shown by default when it has at least one
// non-dimmed (currently offered) course. Groups whose courses are
// all dimmed collapse under the "Show More Courses" button.
// tags: state is one of 'offered' | 'past' | 'planned'.
const teachingNote = 'Fall 2026 (1151 Fall Semester)';

const COURSE_LEVELS = ['Undergraduate', 'Graduate'];

const courses = [
    // ---- Undergraduate Courses ----
    {
        level: 'Undergraduate', group: 'Fall Semester',
        code: 'B57022TS', type: 'Elective',
        title: 'Programming with Python',
        time: 'Monday 13:10–16:00',
        location: 'INS 301',
        className: 'CSE Undergraduate 2A',
        description: 'This course introduces the fundamentals and applications of Python. Topics progress from basic syntax to data structures, object-oriented programming, file handling, and commonly used libraries.',
        dimmed: false, tags: [{sem: '1141', state: 'past'}, {sem: '1151', state: 'offered'}]
    },
    {
        level: 'Undergraduate', group: 'Fall Semester',
        code: 'B5703660', type: 'Required',
        title: 'Operating Systems',
        time: 'Friday 09:20–12:05',
        location: 'ECG B107',
        className: 'CSE Undergraduate 3B',
        description: 'This course explores the fundamental concepts, design principles, and implementation of modern operating systems, including process management, CPU scheduling, synchronization, deadlock avoidance, memory management, and file systems.',
        dimmed: false, tags: [{sem: '1141', state: 'past'}, {sem: '1151', state: 'offered'}]
    },
    {
        level: 'Undergraduate', group: 'Fall Semester',
        code: 'B570332J', type: 'Elective',
        title: 'Systems and Network Administration',
        time: 'Monday 09:20–12:05',
        location: 'ECG 610',
        className: 'CSE Undergraduate 3A',
        description: 'This course develops students\' practical skills in managing modern Linux-based systems and network infrastructure, covering virtualization, enterprise network services, SSH security, system backup, and monitoring tools, with an emphasis on hands-on deployment and real-world system administration.',
        dimmed: false, tags: [{sem: '1151', state: 'offered'}]
    },
    {
        level: 'Undergraduate', group: 'Fall Semester',
        code: 'B570264Z', type: 'Elective',
        title: 'Programming Competency Assessment',
        time: 'See course announcement',
        location: 'INS 203',
        className: 'CSE Undergraduate 2A',
        description: '',
        dimmed: false, tags: [{sem: '1151', state: 'offered'}]
    ...
    {
        level: 'Undergraduate', group: 'Fall Semester',
        code: 'CSCS10032', type: 'Required',
        title: 'Basic Programming (NYCU)',
        time: 'See course announcement',
        location: 'EC315 / EC316 / EC324 (NYCU)',
        className: 'CSE Undergraduate (NYCU)',
        description: '',
        dimmed: false, tags: [{sem: '1151', state: 'offered'}]
    },
    {
        level: 'Undergraduate', group: 'Summer Session',
        code: 'CSCS10032', type: 'Required',
        title: 'Basic Programming (NYCU)',
        time: 'See course announcement',
        location: 'EC315 / EC316 / EC324 (NYCU)',
        className: 'CSE Undergraduate Summer Session',
        description: '',
        dimmed: true, tags: [{sem: '1143', state: 'past'}]
    },
    {
        level: 'Undergraduate', group: 'Spring Semester',
        code: 'B5701R9E', type: 'Required',
        title: 'Digital Logic',
        time: 'Tuesday 13:10–16:00',
        location: 'ECG B107',
        className: 'CSE Undergraduate 1A',
        description: 'This course covers the fundamental concepts of digital logic design, including Boolean algebra, logic gates, combinational and sequential circuits, techniques for circuit reduction, and introduction to digital systems.',
        dimmed: true, tags: [{sem: '1132', state: 'past'}, {sem: '1142', state: 'past'}, {sem: '1152', state: 'planned'}]
    },
    {
        level: 'Undergraduate', group: 'Spring Semester',
        code: 'B5701R9F', type: 'Required',
        title: 'Digital Logic Laboratory',
        time: 'Wednesday 13:10–16:00',
        location: 'ECG 610',
        className: 'CSE Undergraduate 1A',
        description: 'A hands-on laboratory course focuses on digital logic design using breadboards and CAD tools. The course emphasizes practical skills in digital logic design, including circuit construction, debugging, and design verification.',
        dimmed: true, tags: [{sem: '1132', state: 'past'}, {sem: '1142', state: 'past'}, {sem: '1152', state: 'planned'}]
    },
    // ---- Graduate Courses ----
    {
        level: 'Graduate', group: 'Fall Semester',
        code: 'M57015RI', type: 'Elective',
        title: 'Introduction to Electronic Design Automation',
        time: 'Tuesday 13:10–16:00',
        location: 'ECG 711',
        className: 'CSE Master\'s Program 1A',
        description: 'This interdisciplinary course bridges computer science and electrical engineering, focusing on IC design processes and EDA. The course enhances understanding of chip technologies and algorithmic implementation skills.',
        dimmed: true, tags: [{sem: '1141', state: 'past'}]
    },
    {
        level: 'Graduate', group: 'Fall Semester',
        code: 'M5701P9I', type: 'Elective',
        title: 'Evolutionary Computation',
        time: 'TBD',
        location: 'TBD',
        className: 'CSE Master\'s Program 1A',
        description: '',
        dimmed: true, tags: [{sem: '1161', state: 'planned'}]
    },
    {
        level: 'Graduate', group: 'Spring Semester',
        code: 'M57015WQ', type: 'Elective',
        title: 'Model Optimization for Deep Learning',
        time: 'Monday 13:10–16:00',
        location: 'ECG 610',
        className: 'CSE Master\'s Program 1A',
        description: 'This course covers deep learning fundamentals, model compression techniques (quantization, pruning, knowledge distillation, low-rank factorization, NAS), and hardware-accelerated deployment for real-world industry applications.',
        dimmed: true, tags: [{sem: '1142', state: 'past'}, {sem: '1152', state: 'planned'}]
    },
];
function buildCoursesHtml() {
    let html = '<h2>Teaching Courses</h2>';
    if (teachingNote) {
        html += `<div class="course-semester-note">Currently showing: <strong>${teachingNote}</strong></div>`;
    }
    COURSE_LEVELS.forEach(level => {
        const levelCourses = courses.filter(c => c.level === level);
        if (!levelCourses.length) return;
        html += `<h3 class="course-section-title">${level} Courses</h3>`;
        const order = [];
        levelCourses.forEach(c => { if (!order.includes(c.group)) order.push(c.group); });
        const vis = [], hid = [];
        order.forEach(g => {
            const gc = levelCourses.filter(c => c.group === g);
            (gc.some(c => !c.dimmed) ? vis : hid).push([g, gc]);
        });
        vis.forEach(([g, gc]) => { html += renderCourseGroup(g, gc); });
        if (hid.length) {
            const gid = level.toLowerCase().replace(/[^a-z]+/g, '-') + '-more-group';
            html += `<div class="hidden-item course-group-hidden" id="${gid}">`;
            hid.forEach(([g, gc]) => { html += renderCourseGroup(g, gc); });
            html += `</div><button class="show-more-btn" onclick="toggleCourseGroup('${gid}', this)">Show More Courses</button>`;
        }
    });
    return html;
}
function renderCourseGroup(label, groupCourses) {
    return `<div class="course-semester-group"><div class="course-semester-label">${label}</div><div class="course-grid">${groupCourses.map(renderCourseCard).join('')}</div></div>`;
}
function renderCourseCard(c) {
    const inactive = c.dimmed ? ' course-inactive' : '';
    const typeCls = c.type === 'Required' ? 'tag-required' : 'tag-elective';
    const tags = (c.tags || []).map(t => `<span class="tag-${t.state}">${t.sem}</span>`).join('');
    // Info rows: render only the fields that have a value, so blank data degrades cleanly.
    const info = [['Time', c.time], ['Location', c.location], ['Class', c.className]]
        .filter(([, v]) => v)
        .map(([k, v]) => `<span><strong>${k}:</strong> ${v}</span>`)
        .join('');
    return `<div class="course-card${inactive}" onclick="toggleCourseCard(this)">`
        + `<div class="course-card-header"><div class="course-code">${c.code}</div>`
        + `<span class="course-type-tag ${typeCls}">${c.type}</span></div>`
        + `<div class="course-title">${c.title}</div>`
        + `<div class="course-info">${info}</div>`
        + (c.description ? `<div class="course-description"><p>${c.description}</p></div>` : '')
        + `<div class="course-offered-tags">${tags}</div></div>`;
}

function renderCourses() {
    const section = document.getElementById('teaching');
    if (!section) return;
    section.innerHTML = buildCoursesHtml();
}
...
function openAlbumLightbox(item) {
    ...
    if (!img) return;
    const box = document.getElementById('album-lightbox');
    const boxImg = document.getElementById('album-lightbox-img');
    const cap = document.getElementById('album-lightbox-caption');
    if (!box || !boxImg) return;
    boxImg.src = img.src;
    boxImg.alt = img.alt || '';
    if (cap) cap.textContent = item.dataset.caption || img.alt || '';
    box.classList.add('open');
    document.body.style.overflow = 'hidden';
}

function closeAlbumLightbox(e) {
    // When clicking the enlarged image itself, keep the lightbox open
    if (e && e.target && e.target.id === 'album-lightbox-img') return;
    const box = document.getElementById('album-lightbox');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    try { renderCourses(); }         catch (e) { console.error('renderCourses:', e); }
    ...
    const REVEAL_SELECTOR =
        ...
        '.lab-stats-bar, .album-group, .album-item';
